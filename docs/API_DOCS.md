...
All API requests are authenticated using **app credentials** passed in the JSON request body:
...
| `403` | `invalid_credentials` | Wrong `appSecret` | Verify your `appSecret` from the dashboard |
